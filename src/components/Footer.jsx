  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-bottom">
        ...
        <p>© Copyright 2026 Parrow Skills Technologies India Limited. All rights reserved. | Developed by <a href="#" style={{ color: '#fbbf24', textDecoration: 'none', fontWeight: 'bold' }}>Quotec IT Solutions</a></p>
      </div>
    </footer>
  );
}

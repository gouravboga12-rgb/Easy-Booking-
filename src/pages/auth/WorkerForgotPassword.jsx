      ...
      <div className="auth-card">
        ...
        <p className="auth-sub">
          {success
            ...
            : step === 1
            ? 'Enter your worker email address to receive a 6-digit security OTP'
        ...
        {success ? (
          <div className="auth-success-state" style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <p style={{ color: '#888', fontSize: '14px', marginTop: '8px' }}>Redirecting you to the worker login page...</p>
            <div style={{ marginTop: '24px' }}>
              <Link to="/login-worker" className="auth-submit" style={{ textDecoration: 'none' }}>
                Go to Worker Login
              </Link>
            </div>
          </div>
          ...
          <form onSubmit={handleRequestOtp}>
            ...
            <div style={{ marginTop: '20px', textAlign: 'center' }}>
              <Link to="/login-worker" style={{ color: '#888', textDecoration: 'none', fontSize: '14px', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                <HiChevronLeft /> Back to Worker Login
              </Link>
            </div>
          </form>
        ) : (
          <form onSubmit={handleResetPassword}>
            ...
            <div style={{ marginTop: '20px', textAlign: 'center' }}>
              <button type="button" className="auth-back" onClick={() => setStep(1)} style={{ background: 'none', border: 'none', color: '#888', cursor: 'pointer', fontSize: '14px' }}>
                ← Back
              </button>
            </div>
          </form>
